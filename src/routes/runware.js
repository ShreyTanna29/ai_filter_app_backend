...
function postRunware(payload_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function* (payload, timeoutMs = 180000) {
...
function postRunwareWithRetry(payload_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function* (payload, timeoutMs = 180000, retries = 1) {
      var _a;
      let lastErr = null;
...
router.post("/runware/upload-image", upload.single("image"), (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    try {
      let imageParam;
      const urlFromBody =
        (_a = req.body) === null || _a === void 0 ? void 0 : _a.imageUrl;
      ...
      const msg =
        ((_e =
          (_d =
            (_c =
              (_b = err === null || err === void 0 ? void 0 : err.response) ===
                null || _b === void 0
                ? void 0
...
router.post("/runware/generate-photo", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    try {
      const {
      ...
      try {
        ...
        const code =
          (primaryErr === null || primaryErr === void 0
            ? void 0
            : primaryErr.code) ||
          ((_a =
            primaryErr === null || primaryErr === void 0
              ? void 0
              : primaryErr.response) === null || _a === void 0
            ? void 0
            : _a.status);
        const isTimeoutLike =
          code === 524 ||
      ...
      const data = response.data;
      const resultItem = Array.isArray(
        data === null || data === void 0 ? void 0 : data.data
      )
        ? data.data.find(
            (d) =>
              (d === null || d === void 0 ? void 0 : d.taskType) ===
              "imageInference"
          ) || data.data[0]
        : data === null || data === void 0
        ? void 0
        : data.data;
      const imageURL =
        (resultItem === null || resultItem === void 0
          ? void 0
          : resultItem.imageURL) ||
        (resultItem === null || resultItem === void 0
          ? void 0
        ...
        (resultItem === null || resultItem === void 0
          ? void 0
          : resultItem.imageDataURI);
      const imageUUID =
        resultItem === null || resultItem === void 0
          ? void 0
          : resultItem.imageUUID;
      if (!imageURL) {
        res.status(502).json({
          success: false,
