        ...
        if (passwordMatch) {
            ...
            if (user.role === "admin") {
                ...
                if (user.totpEnabled && user.totpSecret) {
                    ...
                    const tempToken = Buffer.from(`2fa:${email}:${Date.now()}:${Math.random()}`).toString("base64");
                ...
                if (!user.totpEnabled) {
                    ...
                    const tempToken = Buffer.from(`setup:${email}:${Date.now()}:${Math.random()}`).toString("base64");
...
router.post("/2fa/setup", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        pending2FAVerifications.set(tempToken, Object.assign(Object.assign({}, pending), { secret: secret }));
...
router.post("/2fa/setup/verify", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
